package com.example.springbootplus.common;
...
public class CodeMsg {
    ...
    public static CodeMsg FILE_NAME_EXIST = new CodeMsg(-8, "文件名已存在！");
    ...
    //登录类错误码
    public static CodeMsg ADMIN_LOGIN_ERROR = new CodeMsg(-3000, "用户名或密码错误！");
    public static CodeMsg ADMIN_USER_UNABLE = new CodeMsg(-3001, "该用户已被冻结，请联系管理员！");
    public static CodeMsg ADMIN_USER_ROLE_UNABLE = new CodeMsg(-3002, "该用户所属角色状态不可用，请联系管理员！");
    public static CodeMsg ADMIN_USER_ROLE_AUTHORITES_EMPTY = new CodeMsg(-3003, "该用户所属角色无可用权限，请联系管理员！");
    ...
    public static CodeMsg ADMIN_MENU_DELETE_ERROR = new CodeMsg(-4004, "该菜单下有子菜单，不允许删除！");
    //后台角色管理类错误码
    ...
    //黑名单管理类错误码
    public static CodeMsg BLACK_LIST_ADD_ERROR = new CodeMsg(-9000, "黑名单添加失败，请联系管理员！");
    public static CodeMsg BLACK_LIST_CANT_SELF = new CodeMsg(-9000, "不能将自己添加到黑名单！");
}